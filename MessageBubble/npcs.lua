...
local NPCs =
{
	...
	[ 236 ] = {
		...
		[ "Door:Galvin's Gear"				] = "ガルヴィン旅行用品店",

		[ "Door:\"Steaming Sheep\""			] = "蒸気の羊亭",
	},
	...
	[ 238 ] = {
		...
		[ "Hariga-Origa"					] = "ハリガオリガ",
		[ "Hilkomu-Makimu"					] = { "ヒルコムマキム", "<ショップ:魔法 黒>" },
		[ "Hobibi"							] = "ホビビ",
		[ "Honoi-Gomoi"						] = "ホノイゴモイ",
		[ "Hororo"							] = "ホロロ",
		[ "Ildy-Goldy"						] = "イルディゴルディ",
		...
		[ "Shatoto"							] = "シャトト",
		[ "Shohrun-Tuhrun"					] = { "ショウルントゥウルン", "<ショップ:魔法 白>" },
	...
	[ 240 ] = {
		...
		[ "Sugn"							] = "スグン",
		[ "Suspicious Tarutaru"				] = { "サスピシャス・タルタル", "<モンストロス案内>" },
