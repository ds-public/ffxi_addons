...
--		end
		...
		elseif( S{   4,   5,   8,  16,  17,  36,  38,  45,  48,  49,  53,  62,  71,  78,  94,  95,  96,  97, 173, 176, 177, 178, 219, 234, 246, 247, 249, 313, 339, 410, 512, 558, 559, 565, 566, 615, 643, 704, 705, 717, 772 }[ message ] ) then
			-- 無視して良いメッセージ
			--   4 対象は範囲外
			--   5 対象が見えない
			--   8 経験値を得た
